...
class MyGUI:
    ...
    def __init__(self, main_window):
        ...
        self.entry_1.pack()
        self.but_1 = Button(self.main_window, text = 'Keywords Extaction', width=38, command = self.keywords_extraction)
        self.but_1.pack()
        self.but_2 = Button(self.main_window, text = 'Add to base', width=38, command = self.add_to_base)
        self.but_2.pack()
        self.but_3 = Button(self.main_window, text = 'Get from base', width=38, command = self.get_from_base)    
        self.but_3.pack()
        self.but_4 = Button(self.main_window, text = 'Edit link', width=38, command = self.edit_link)    
        self.but_4.pack()
        ...
        self.entry_2.pack()
        self.but_5 = Button(self.main_window, text = 'Clean source', width=38, command = self.clean_source)
        self.but_5.pack()
        self.but_6 = Button(self.main_window, text = 'Clean history', width=38, command = self.clean_history)
        self.but_6.pack()
        self.counter = 2
